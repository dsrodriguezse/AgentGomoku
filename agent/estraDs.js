class MinimaxAgentDS extends Agent {
    ...
    evaluateBoard(board, color) {
        const scores = {
            win5: this.evaluateLines(board, color, 5) * 1000000,
